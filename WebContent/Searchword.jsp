...
ArticalInfo info = infoDao.loadinfo(word);
if(info==null){
	%>
		没有找到数据！
	<% 
									...
									<div class="col-xs-6 col-sm-3 pricing-box" >
										<div class="widget-box" >
											<div class="widget-header header-color-dark" style="background: #404040;border-color: #fff;" >
												<h5 class="bigger" style="color:#fff;height: 40px;"><%=info.getTitle()%></h5>
											</div>
											...
											<div class="widget-body" >
												<div class="widget-main">
													<ul class="list-unstyled spaced2" style="height: 80px">
														<li >
															...
															<%=info.getContext().substring(0,30) %>...
														</li>
													</ul>
												...
												<div>
												<button name="title"  value="<%=info.getTitle() %>" class="btn btn-block btn-inverse">
													查看
												</button>
